...
###########################
    ...
    { 
        Send-MailMessage -to $recipients -Cc $cc_recipients -from "Monitor Script <monitorscript@aswigsolutions.com>" -SmtpServer $smtp_server -Subject "[ALERT] [QA] ESXi host monitoring" -Credential $mycreds -BodyAsHtml "$content"
    }
    Else 
    {
