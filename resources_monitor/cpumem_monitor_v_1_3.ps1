...
Function CheckCPUMemDisk
{
    ...
    $Names = $VM.Name
        If ($VM.PowerState -eq "PoweredOn")
        {
            ...
            Invoke-VMScript -VM $Names -GuestCredential $local_cred -ScriptText "Start-Process \\data1\Software\CCleaner\CCleaner64.exe /AUTO -Verb RunAs" -ScriptType Powershell  
